...
function IconCheckCircle({ size = 14 }) { return (<svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="9" /><path d="M8.5 12.5l2.5 2.5 5-5" /></svg>); }
function IconShield({ size = 14 }) { return (<svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2.5l7.5 3.5v5.5c0 5-3.2 8.3-7.5 9.9-4.3-1.6-7.5-4.9-7.5-9.9V6l7.5-3.5z" /></svg>); }
function IconBolt({ size = 14 }) { return (<svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor"><path d="M13 2 4 14h6l-1 8 9-12h-6l1-8z" /></svg>); }
function IconArrowRight({ size = 17 }) { return (<svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14M13 6l6 6-6 6" /></svg>); }
    ...
    <main className="landingPage">
      ...
      <section className="landingHero">
        <div className="landingCopy">
          ...
          <p className="landingLead">Book a reliable cab for your journey with clear pricing, verified drivers and a smoother travel experience.</p>
        ...
        <div className="landingVisual">
          <div className="landingVisualTop"><span>VOYNU TRIP</span><span className="landingLive"><i /> READY TO BOOK</span></div>
          <RoutePreview />
      ...
      <footer className="landingFooter"><div><strong>VOYNU</strong> © {new Date().getFullYear()}</div><div>Travel safe. Travel smart.</div></footer>
      ...
      <style jsx>{`
        ...
        .landingHeader { position:sticky; top:0; z-index:20; background:rgba(255,255,255,.92); border-bottom:1px solid #E5E9EF; backdrop-filter:blur(14px); }
        .landingHeaderInner { width:min(1180px,calc(100% - 32px)); min-height:70px; margin:0 auto; display:flex; align-items:center; justify-content:space-between; gap:12px; }
        .landingBrand { display:flex; align-items:center; gap:10px; color:#0D1B2A; font-size:19px; font-weight:800; letter-spacing:-.5px; text-decoration:none; }
        ...
        .landingLogin { padding:10px 14px; color:#445163; font-size:13px; font-weight:700; text-decoration:none; }
        .landingSignup { padding:10px 18px; border-radius:999px; background:linear-gradient(135deg,#00B4A6,#2563EB); color:#fff; font-size:13px; font-weight:800; text-decoration:none; box-shadow:0 9px 22px rgba(37,99,235,.18); }
        ...
        .landingPrimaryButton,.landingSecondaryButton { min-height:54px; border-radius:15px; display:flex; align-items:center; justify-content:center; gap:9px; font-size:14px; font-weight:800; text-decoration:none; }
        ...
        .landingRouteCardOne { left:10%; top:30%; }.landingRouteCardTwo { right:9%; bottom:29%; }
        ...
        .landingTrustRow strong { color:#0D1B2A; font-size:11px; }.landingTrustRow span { margin-top:3px; color:#87919E; font-size:9px; }
        .landingFooter { min-height:64px; display:flex; align-items:center; justify-content:space-between; width:min(1180px,calc(100% - 32px)); margin:0 auto; color:#7A8491; font-size:10px; }.landingFooter strong { color:#0D1B2A; }
        html[data-voynu-theme="dark"] .landingPage { background:linear-gradient(160deg,#071321 0%,#0D1B2A 58%,#102D35 100%); color:#F8FAFC; }
        html[data-voynu-theme="dark"] .landingHeader { background:rgba(7,19,33,.92); border-color:#263A50; }
        html[data-voynu-theme="dark"] .landingBrand,html[data-voynu-theme="dark"] h1,html[data-voynu-theme="dark"] .landingVisualTop,html[data-voynu-theme="dark"] .landingFooter strong { color:#F8FAFC; }
        html[data-voynu-theme="dark"] .landingLead { color:#A9B5C3; }
        html[data-voynu-theme="dark"] .landingSecondaryButton { background:#0D1B2A; color:#F8FAFC; border-color:#35506B; }
        html[data-voynu-theme="dark"] .landingVisual { background:rgba(13,27,42,.78); border-color:#263A50; }
        html[data-voynu-theme="dark"] .landingTrustRow { background:#263A50; border-color:#263A50; }
        html[data-voynu-theme="dark"] .landingTrustRow div { background:#10263A; }.landingTrustRow strong { color:#0D1B2A; }
        html[data-voynu-theme="dark"] .landingTrustRow strong { color:#F8FAFC; }.landingFooter { border-top:1px solid transparent; }
        @media (max-width:920px){.landingHero{grid-template-columns:1fr;gap:42px;padding-top:42px}.landingCopy{text-align:center;display:flex;flex-direction:column;align-items:center}.landingLead{max-width:560px}.landingVisual{width:min(620px,100%);margin:0 auto}}
        @media (max-width:560px){.landingHeaderInner,.landingHero,.landingFooter{width:min(100% - 24px,1180px)}.landingHero{min-height:auto;padding:38px 0 44px}h1{font-size:clamp(46px,14vw,64px);letter-spacing:-2.3px}.landingPills{justify-content:center}.landingVisual{padding:12px;border-radius:24px}.landingRoute{height:290px;border-radius:18px}.landingTrustRow div{min-height:58px;padding:8px}.landingTrustRow strong{font-size:10px}.landingTrustRow span{font-size:8px}.landingFooter{min-height:72px;flex-direction:column;justify-content:center;gap:4px}.landingNav{gap:5px}.landingLogin{padding:9px 8px}}
      `}</style>
    </main>
  );
}

const pillStyle = { display:"flex", alignItems:"center", gap:8, padding:"8px 14px 8px 8px", borderRadius:30, background:"#FFFFFF", border:"1px solid #E5E9EF", color:"#344052", fontSize:12, fontWeight:700 };
const pillIconStyle = { width:24, height:24, display:"flex", alignItems:"center", justifyContent:"center", borderRadius:"50%", background:"#E9FBF8", color:"#008F84" };