...
export default function DriverPage() {
  ...
  const active=bookings.filter((b)=>ACTIVE_STATUSES.includes(b.booking_status)), upcoming=bookings.filter((b)=>b.booking_status==="driver_assigned"), past=bookings.filter((b)=>b.booking_status==="trip_completed");
