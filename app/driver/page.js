...
export default function DriverPage() {
  ...
  useEffect(() => {
    ...
    const activeTrip = bookings.find((b) => ["driver_assigned", "on_the_way", "arrived", "trip_started"].includes(b.booking_status));
    if (!activeTrip) {
  ...
  const activeTrips = bookings.filter((b) => !["trip_completed", "cancelled"].includes(b.booking_status));
