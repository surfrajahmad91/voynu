    ...
    >
      ...
      <style jsx>{`
        ...
        @media (max-width: 700px) {
          ...
          .homeProductOption { min-height: 66px; gap: 4px; padding: 7px 4px; border-radius: 14px; }
        ...
        @media (max-width: 520px) {
          ...
          .homeProductOption { min-height: 64px; gap: 4px; padding: 6px 3px; border-radius: 13px; }
